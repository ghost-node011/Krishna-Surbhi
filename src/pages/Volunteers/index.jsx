...
import { PHOTOS, teamByGroup } from '../../data';
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn>
            <GroupHeader
              ...
              text="Rakesh joined as our gardener and is today the backbone of Krishna Surbhi. Pooja gives her time to feeding, cleaning and caring for the cows."
            />
          </FadeIn>
          ...
          <FadeIn>
            <div className="text-center mb-14">
              ...
              <h2 className="font-serif text-4xl md:text-5xl text-forest-dark mt-2">
                What our volunteers <em className="italic text-forest">do here</em>
              </h2>
            </div>
          </FadeIn>
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-6">
          <FadeIn>
            <h2 className="font-serif text-4xl md:text-5xl text-white mb-4 leading-tight">
              Want to give your time <em className="italic text-saffron">to Gau Seva?</em>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                Meet the Core Team <ArrowRight size={14} />
              </Link>
            </div>
          </FadeIn>
        </div>
